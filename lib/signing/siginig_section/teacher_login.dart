...
import 'package:dujo_application/teacher_section/normal_teacher/common_teacher/common_teacher_home.dart';
          ...
          child: Column(
            children: [
              ...
              InkWell(
                child: Padding(
                  padding:
                      EdgeInsets.only(left: widget.screenSize.width * 1 / 1.9),
                  child: Text(
                    "Forgot Password ?",
                    ...
                    try {
                      await FirebaseAuth.instance
                          .signInWithEmailAndPassword(
                              email: teacheridController.text.trim(),
                              password: passwordController.text.trim())
                          .then((value) => Get.to(CommonTeacherHome(
                                schoolId: widget.schoolId,
